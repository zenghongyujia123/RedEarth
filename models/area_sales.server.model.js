...
module.exports = function (appDb) {
  ...
  AreaSalesSchema.pre('save', function (next) {
    if (this.last_month_sales_count_3 !== 0 || this.last_month_sales_count_2 !== 0 || this.last_month_sales_count_1 !== 0) {
      ...
      this.safe_stock = parseInt(( this.last_month_sales_count_3 + this.last_month_sales_count_2 + this.last_month_sales_count_1) / 3) * isNaN(parseInt(this.area_safe_stock))?0:parseInt(this.area_safe_stock)
    }
